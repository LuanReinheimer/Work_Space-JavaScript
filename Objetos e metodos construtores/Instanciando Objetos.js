...
// Instanciação de Objetos - Forma 5 - Objeto a partir das nossas classes criadas acima.

const p1 = new Pessoa('Felicity', 'Silva');
console.log(p1);
...
// 1. imprimindo o objeto;
 console.log(programa);

// 2. Acessando o objeto;
...
// 4. Deletando atributos do objeto;
...
// Instanciação de Objetos - Forma 4 - Função Construtora Exemplo 2

function Bens(nome, tipo, valor){
    this.nome = nome;
    this.tipo = tipo;
    this.valor = valor;
}

function Pessoa1(nome, idade, bens){
    this.nome = nome;
    this.idade = idade;
    this.bens = bens;
}
...
// Bens
var golf = new Bens('Golf', 'carro', 30000);
// Pessoas
var joao = new Pessoa('Joao', 23, [golf]);
